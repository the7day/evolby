...
<jsp:include page="../header.jsp">
  <jsp:param name="title" value="Commission - View election events" />
</jsp:include>
...
<f:view>
    ...
    <ul class="buttons">
      <li>
        <h:outputLink  value="createNewEvent.jsp">
          Create new event
            <f:param name="elecId" value="#{createElectionEvent.elecId}"/>
        </h:outputLink>
      </li>
      <li>
        <h:outputLink styleClass="buttons" value="mainCommissioner.jsp">
            Menu
        </h:outputLink>
      </li>
    </ul>
