...
<jsp:include page="../header.jsp">
  <jsp:param name="title" value="Admin - View elections" />
</jsp:include>
...
<f:view>
    ...
    <h:dataTable cellspacing="1" styleClass="elections" value="#{createElection.elections}" var="item">
        ...
        <h:column>
            ...
            <h:outputLink  value="viewElection.jsp">
                view
                ...
                <br/>
    <h:outputLink styleClass="button" value="mainAdmin.jsp">Menu</h:outputLink>
</f:view>
